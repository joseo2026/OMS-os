...
export function makeStyles(C) {
  return {
    ...
    header: { background: C.surface, borderBottom: `1px solid ${C.border}`, padding: "14px 20px", paddingTop: "calc(env(safe-area-inset-top) + 14px)", display: "flex", justifyContent: "space-between", alignItems: "center" },
