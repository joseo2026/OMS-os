...
// IRS income periods for quarterly payments
const QUARTERS = [
...
export default function Export({ data }) {
  ...
  function exportExcel() {
    ...
    XLSX.writeFile(wb, `Ocasio-${year}-Business-Report.xlsx`);
  }
    ...
    <div>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 20 }} className="no-print">
        <button onClick={() => setYear(y => y - 1)}
          style={{ ...S.btnSecondary, padding: "8px 14px" }}>←</button>
      ...
      <div style={{ ...S.card, marginBottom: 12 }} className="no-print">
        ...
        <button
          ...
          onClick={exportExcel}
          disabled={annual.jobs.length === 0 && annual.expenses.length === 0 && annual.mileage.length === 0}
        >
        ...
        {annual.jobs.length === 0 && annual.expenses.length === 0 && annual.mileage.length === 0 && (
